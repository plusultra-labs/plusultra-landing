...
export const allWork: WorkItem[] = [
  ...
  },
  {
    ...
    service: "ai-product-development",
    image: "/work/e-signature.svg",
    paragraphs: [
      "Signing a document legally in Europe usually means an enterprise subscription. The platform lets Italian businesses send documents for legally valid electronic signature and pay per signature instead.",
