...
export const allWork: WorkItem[] = [
  ...
  },
  {
    slug: "ts-sites",
    name: "TS-Sites",
    tagline: "One system, a fleet of attraction websites",
    period: "2025 - today",
    tags: ["Own product", "Travel", "Content system"],
    service: "custom-platforms",
    image: "/work/ts-sites.jpg",
    url: "https://royal-alcazar-seville-tickets.com",
    paragraphs: [
      "TS-Sites is our multi-site publishing system: from one dashboard it generates and runs complete ticket websites for world attractions, each on its own domain, each in multiple languages.",
      "Editors work with visual blocks, AI helps write and update pages, and every site ships with search-engine best practices built in. Adding a new attraction site takes hours, not weeks.",
    ],
  },
  {
    slug: "insightflow",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "It's a family of booking platforms (hotels, events, experiences) built on one shared core: accounts, credit wallets, coupons, and vouchers, connected to real travel inventory.",
    ],
  },
  {
    slug: "fms-portal",
